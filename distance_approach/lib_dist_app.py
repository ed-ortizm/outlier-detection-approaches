...
def nns(data, n_neighbors=2, p=2):

    NNs = NearestNeighbors(n_neighbors=n_neighbors, algorithm='auto', metric=lp, metric_params={'p': p})
...
def plt_data(data, fname, path='./', face_color = True):
